  ...
  asyncHandler(async (req, res) => {
    try {
      uploadPosters.single("img")(req, res, async function (err) {
        ...
        let imageUrl = "no_url";
        if (req.file) {
          imageUrl = `https://storebackend-production-3700.up.railway.app/image/poster/${req.file.filename}`;
        }
  ...
  asyncHandler(async (req, res) => {
    try {
      ...
      uploadPosters.single("img")(req, res, async function (err) {
        ...
        if (req.file) {
          image = `https://storebackend-production-3700.up.railway.app/image/poster/${req.file.filename}`;
        }
